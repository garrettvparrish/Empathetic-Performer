...
static const int NOTE_CHANGE = 144;
static const int MODE_CHANGE = 176;
...
@interface SerialExample : NSObject <MIDIReceiver> {
...
//@property NSMutableDictionary *noteVariance;
//@property NSMutableDictionary *noteProbability;
